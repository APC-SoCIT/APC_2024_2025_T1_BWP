        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <h4 class="mb-3">Video Catalogue</h4>
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <p class="card-text"><strong>Abstract:</strong> {{ Str::limit($video->description, 100) }}</p>
                                    <p class="card-text"><strong>Keywords:</strong> {{ $video->keywords }}</p>
                                    ...
                                    @endif
                                    <div class="mt-auto">
                                    <a href="{{ Storage::url($video->file_path) }}" class="btn btn-primary btn-block" target="_blank" rel="noopener noreferrer">Open File</a>
                                    </div>
                                </div>
                            </div>
                        </div>
