                        ...
                        <div class="card-body container-fluid">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($research->file_path)
                                                    <a href="{{ Storage::url('public/files/research/' . basename($research->file_path)) }}" class="btn btn-primary" target="_blank">Open File</a>
                                                @else
                                                    No file available
                                                @endif
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" class="text-center">No research papers available.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
